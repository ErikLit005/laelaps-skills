---
name: humanize
description: Remove AI writing patterns and add genuine voice to a piece of text. Use when the user asks to "humanize" text, de-AI a draft, or make copy stop sounding like ChatGPT wrote it.
---
...
This skill is based on [Wikipedia:Signs of AI writing](https://en.wikipedia.org/wiki/Wikipedia:Signs_of_AI_writing), maintained by WikiProject AI Cleanup, via the [agent-foundations-starter](https://github.com/JamsusMaximus/agent-foundations-starter/blob/main/skills/humanizer/SKILL.md) humanizer skill. The patterns documented there come from observations of thousands of instances of AI-generated text on Wikipedia.
